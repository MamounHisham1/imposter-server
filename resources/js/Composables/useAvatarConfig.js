...
export const AVATAR_GENDER = {
      ...
      "hair": {
          ...
          "background_removed_df76f6eb-46e9-46cb-b4a2-12a12a53314a_output.png": "male"
      },
      "beard": {
          "beard3.png": "male",
          "beard001.png": "female",
...
export const AVATAR_ITEMS = {
      ...
      "hair": [
          ...
          "haur001.png",
          "hair8.png",
          "gemini_generated_image_mqo0s5mqo0s5mqo0-removebg-preview.png",
      ...
      "beard": [
          ...
          "beard13.png",
          "beard14.png",
          "gemini_generated_image_gsr4u2gsr4u2gsr4-removebg-preview.png",
          "picsart_26-05-17_05-43-43-050.png",
          "picsart_26-05-17_05-36-48-992.png",
          "picsart_26-05-17_05-37-47-009.png",
          "picsart_26-05-17_05-38-12-527.png",
          "picsart_26-05-17_05-38-28-497.png",
          "picsart_26-05-17_05-38-51-621.png",
          "picsart_26-05-17_05-40-05-281.png",
...
function resolveImageFile(filename) {
  ...
  const dupMatch = filename.match(/^(.*)_dup\d+\.png$/)
  if (dupMatch) return dupMatch[1] + '.png'
  return filename
}
...
export function getLayerStyle(layer, filename, containerSize) {
  ...
  const imgFile = resolveImageFile(filename)
  return {
    backgroundImage: `url(${AVATAR_BASE}${imgFile})`,
